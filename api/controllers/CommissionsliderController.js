        ...
        if (req.body) {
            if (req.body._id) {
                if (req.body._id != "" && sails.ObjectID.isValid(req.body._id)) {
                    ...
                    res.json({
                        value: false,
                        comment: "CommissionSlider-id is incorrect"
                    });
                }
            } else {
                user();
            ...
            function user() {
                ...
                CommissionSlider.save(req.body, print);
            }
        } else {
            res.json({
                value: false,
    ...
    delete: function(req, res) {
        if (req.body) {
            if (req.body._id && req.body._id != "" && sails.ObjectID.isValid(req.body._id)) {
                ...
                CommissionSlider.delete(req.body, print);
            } else {
                res.json({
                    value: false,
                    comment: "CommissionSlider-id is incorrect"
    ...
    findone: function(req, res) {
        if (req.body) {
            if (req.body._id && req.body._id != "" && sails.ObjectID.isValid(req.body._id)) {
                ...
                CommissionSlider.findone(req.body, print);
            } else {
                res.json({
                    value: false,
                    comment: "CommissionSlider-id is incorrect"
    ...
    findlimited: function(req, res) {
        if (req.body) {
            if (req.body.pagesize && req.body.pagesize != "" && req.body.pagenumber && req.body.pagenumber != "") {
                ...
                CommissionSlider.findlimited(req.body, callback);
            } else {
                res.json({
                    value: false,
                    comment: "Please provide parameters"
